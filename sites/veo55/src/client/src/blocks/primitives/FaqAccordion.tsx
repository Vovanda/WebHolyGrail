import type { BlockNode, FaqAccordionBlockData, FaqGroupDoc, SiteSettings } from '@veo55/contracts';

import { cn } from '@/lib/utils';
import { listFaqGroups } from '@/lib/api-client';
import { FaqToggleAllButtons } from '@/components/faq/FaqToggleAllButtons';
 ...
 *
 * **R5++ generic.** Не привязан к питомнику — заголовок/лид/CTA приходят
 * данными, контент — из отдельной коллекции.
 *
 * **Дизайн 1:1 с legacy `articles/faq.html`:**
 *  - h1 + emoji + янтарная подчёрта-divider
