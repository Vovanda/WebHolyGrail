 ...
 * по одному-двум; список стоит колонкой и показывает плейлист целиком - в панели,
 * рядом с плеером, в каталоге. Задачи разные, поэтому и контрола два.
 *
 * Что список умеет сверх обычной колонки:
 *
 * - **своя прокрутка** с потолком по высоте: без неё длинный плейлист утаскивает
...
export interface ScrollListProps {
   ...
   *
   * @remarks
   * Плеер переключил видео - список показывает, где это видео в плейлисте. Без
