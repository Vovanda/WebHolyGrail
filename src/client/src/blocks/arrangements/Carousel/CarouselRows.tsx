...
/**
 * @deprecated Устарел. Взамен - `CarouselDeck` для листания чего угодно
 * и `PhotoDeck` для снимков: там общая механика, разметка частей для «Вида блока»
 * и меры, переопределяемые извне.
 *
 * Остаётся ради сайтов, собранных раньше: их код ссылается на него, и удаление
 * из шаблона зеркало унесло бы файл в каждый сайт, где сборка сразу встала бы
 * (R10). Уйдёт, когда сайты переведут на `CarouselDeck`.
 *
