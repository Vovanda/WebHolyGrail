...
/**
 * Окно ввода кода — открывается по нажатию на закрытый ролик.
 *
 * @remarks
 * Замок сам по себе тупик: человек видит, что нельзя, и не понимает, что
 * делать. Поэтому нажатие на закрытый ролик ведёт не в никуда, а сюда, где
...
export function AccessCodeDialog({ token }: AccessCodeDialogProps) {
  // Нажатие на любой закрытый ролик открывает окно. Слушаем на документе, а не
