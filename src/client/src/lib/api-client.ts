...
/**
 * Можно ли этому зрителю смотреть видео.
 *
 * @remarks
 * Спрашивается при рендере страницы, до отрисовки плеера: иначе закрытый видео
...
/**
 * Видео по адресу канала и короткому коду.
 *
 * @remarks
 ...
 *
 * @remarks
 * Закрытые видео сюда не приходят: канал открыт всем, включая поисковик,
...
/**
 * Плейлист по адресу канала и короткому коду.
 *
 * @remarks
 * Закрытые видео приходят вместе с открытыми, но с признаком замка: плейлист и
 * есть витрина, скрывать его состав незачем.
 *
 * Куки зрителя пробрасываются — иначе у вошедшего с правом на плейлист всё
 * выглядело бы закрытым.
 */
/**
 * Плейлист по его номеру — для блока на произвольной странице.
 *
 * @remarks
 * Блоку известен только выбранный плейлист, короткого адреса и канала у него нет.
