 ...
 *
 * @remarks
 * Инвариант (см. memo `HolyGrail/38`): это люди которые заходят в админку и
 * правят контент сайта. Внешние клиенты бизнеса (покупатели product и т.п.) —
 * совершенно другая сущность, живёт в нишевых коллекциях (Owners для veo55),
 * **не здесь**.
 *
