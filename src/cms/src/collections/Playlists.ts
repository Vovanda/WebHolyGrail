 ...
 * стройки и цикл записей автора — один и тот же плейлист с разным содержимым.
 */
export const Playlists: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        position: 'sidebar',
        description:
          'Разовое действие при сохранении: доступ каждой записи плейлиста станет таким. Дальше их можно править по одной.',
      },
    },
    {
      name: 'access',
      label: 'Видимость плейлиста',
      type: 'select',
      defaultValue: 'public',
      options: [
      ...
      admin: {
        position: 'sidebar',
        description:
          'Видимость самого плейлиста. На доступ к видео не влияет: закрытые открывает право на плейлист.',
      },
    },
    {
      name: 'items',
  ...
  hooks: {
    afterChange: [
      /*
        Массовое закрытие и открытие записей плейлиста.

        Курс продают плейлистом, а доступ у каждой записи свой: закрывать их по
        ...
        все записи» связать нельзя, потому что запись живёт и вне плейлиста, а
