 ...
 *
 * @deprecated Показом формы не управляет и в выдаче не участвует. Признак
 * безличен - говорит, что код кому-то выдан, а не что он есть у смотрящего:
 * поле по нему появлялось сразу у всех посетителей и всё равно не у того, кто
 * держит код. Форма ввода стоит у закрытой записи всегда. Оставлен ради сайтов,
 * собранных на прежнем шаблоне (R10).
 *
 * @remarks
 * Живым считается код, который сработает прямо сейчас.
 *
