 ...
 *
 * @remarks
 * Два запроса вместо одного: сначала плейлисты, где состоит видео, потом права
 * зрителя ровно на них. Связь «видео в плейлисте» лежит в массиве внутри плейлиста,
 * и одним запросом от прав к видео не пройти.
 *
