 ...
 *
 * @remarks
 * У видео Payload рисует дефолтную иконку документа: кадр из видео он вытащить
 * не может, а после нарезки исходника по прежнему адресу и вовсе нет. В списке
 * из десяти таких строк одинаковые серые квадраты, и найти нужный видео глазами
 * невозможно.
 *
