  ...
  fields: [
    {
      ...
      tabs: [
        {
          label: 'Сайт',
          description: 'Имя, логотип и контакты - то, что видно в шапке и подвале.',
          fields: [
            {
              name: 'siteName',
              label: 'Имя сайта',
        ...
        {
          label: 'Меню',
          description: 'Ссылки в шапке, подвале и на страницы в соцсетях.',
          fields: [
            {
              name: 'mainNav',
        ...
        {
          label: 'Оформление',
          description: 'Тема, палитра и композиция панелей.',
          fields: [
            {
              name: 'header',
              label: 'Шапка',
              ...
              fields: [
                {
                  name: 'sticky',
                  label: 'Шапка держится наверху при прокрутке',
                  type: 'checkbox',
                  defaultValue: false,
                  admin: {
                    description:
                      'Выключено — шапка уезжает вместе со страницей, наверху остаётся кнопка меню.',
                  },
                },
              ],
            },
            ...
            },
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  admin: {
                    description:
                      'Выбор preset автоматически заполнит 16 hex-полей ниже значениями из плейлиста. Можешь дальше править вручную — это override поверх preset.',
                    components: {
        ...
        {
          label: 'Видео',
          description: 'Плеер, качества и защита от выкачивания.',
          fields: [
            {
              name: 'video',
              label: 'Видео',
              ...
              admin: {
                description:
                  'Во сколько качеств резать загруженное видео. Меняется без разработчика; уже нарезанные видео не пересобираются.',
              },
              fields: [
                {
                  name: 'denied',
                ...
                },
                {
                  ...
                  admin: {
                    description:
                      'Код вводят руками и диктуют по телефону. Шести хватает, пока код живёт минуты; для долгоживущих лучше восемь.',
                  },
                },
                {
                  name: 'codeTtlMinutes',
                  ...
                  admin: {
                    description:
                      'Пять минут, как у одноразового пароля. Дольше ставят коду, который раздают многим.',
                  },
                },
                {
                  name: 'accessDays',
                ...
                {
                  name: 'purgeAfterDays',
                  label: 'Через сколько дней стирать удалённые видео',
                  type: 'number',
                  defaultValue: 30,
                  min: 1,
                  max: 365,
                  admin: {
                    description:
                      'Удалённый видео сразу пропадает с сайта, а файлы лежат ещё столько дней — на случай, если удалили по ошибке.',
                  },
                },
                {
                  name: 'qualities',
                  ...
                  admin: {
                    description:
                      'Каждое качество — отдельный проход по видео при нарезке и место в хранилище. Ступени выше исходника не создаются.',
                  },
                },
                {
                  name: 'cryptoPeriod',
                  ...
                  defaultValue: 15,
                  /*
                    От одного до четырёх нельзя, а ноль можно: ноль означает
                    «не делить вовсе», и ключ у записи один. Часть длится
                    четыре секунды, а запас ключей возвращается по одному
                    в двадцать: на более мелкой нарезке зритель просит ключи
                    быстрее, чем они восполняются, и упирается в предел посреди
                    просмотра - защита от выкачивания начинает бить по тому,
                    кого должна пускать.
                  */
                  validate: (value: unknown) => {
                    ...
                    if (number > 0 && number < 5) {
                      return 'Меньше пяти частей под ключом зритель упрётся в запрет по частоте. Поставьте 5 и больше или 0 - вся запись под одним ключом.';
                    }
                    return true;
                  },
                  admin: {
                    description:
                      'Часть длится 4 секунды, поэтому 15 — это минута под одним ключом. Чем меньше число, тем меньше отдаёт утёкший ключ и тем чаще плеер ходит за новым. Меньше 5 нельзя: зритель начнёт упираться в запрет по частоте. Ноль — вся запись под одним ключом. Значение действует на записи, нарезанные после его изменения.',
                  },
                },
              ],
            },
        ...
        {
          label: 'Блог',
          description: 'Как показывать статьи и обсуждения.',
          fields: [
            {
              name: 'blog',
              label: 'Блог',
        ...
        {
          label: 'Данные',
          description: 'Оператор персональных данных и текст политики.',
          fields: [
            {
              name: 'personalData',
              ...
              fields: [
                ...
                },
                {
                  ...
                  type: 'email',
                  admin: {
                    description: 'Сюда пишут с просьбой удалить данные или отозвать согласие.',
                  },
                },
                {
