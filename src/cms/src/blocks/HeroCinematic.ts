  ...
  fields: [
    {
      ...
      admin: {
        description:
          'Прямая ссылка на файл. Видео идёт без звука и по кругу — так его разрешают проигрывать браузеры без нажатия. Держите ролик коротким и лёгким: он грузится у каждого посетителя.',
      },
    },
    {
      name: 'poster',
