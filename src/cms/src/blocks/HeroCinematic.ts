  ...
  fields: [
    {
      ...
      admin: {
        description:
          'Прямая ссылка на файл. Видео идёт без звука и по кругу — так его разрешают проигрывать браузеры без нажатия. Держите видео коротким и лёгким: 5-10 секунд и до 5 МБ. Он грузится у каждого посетителя, и тяжёлый файл заметно тормозит первый экран.',
      },
    },
    {
      name: 'poster',
