...
export const RequestFormBlock: Block = {
  ...
  fields: [
    ...
    {
      name: 'policyHref',
      label: 'Ссылка на политику обработки данных',
      type: 'text',
      defaultValue: '/privacy',
      admin: {
        description:
          'Адрес страницы с политикой. Галочка согласия под формой ссылается сюда — без неё форма не отправляется.',
      },
    },
    {
      name: 'consentLabel',
      label: 'Текст рядом с галочкой согласия',
      type: 'text',
      defaultValue: 'Согласен на обработку персональных данных',
      admin: {
        description: 'Ссылка на политику подставится сама в конце фразы.',
      },
    },
  ],
};
