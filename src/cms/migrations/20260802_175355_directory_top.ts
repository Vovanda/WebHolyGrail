// @safe-bluegreen — новая колонка города по умолчанию
// Правлено руками: генератор включал новую колонку в SELECT из старой
// таблицы, где её ещё нет. В перенос не входит, берётся из DEFAULT.
import { MigrateUpArgs, MigrateDownArgs, sql } from '@payloadcms/db-sqlite';

export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.run(
    sql`ALTER TABLE \`pages_blocks_specialist_directory\` ADD \`default_city_id\` integer REFERENCES cities(id);`,
  );
  await db.run(
    sql`CREATE INDEX \`pages_blocks_specialist_directory_default_city_idx\` ON \`pages_blocks_specialist_directory\` (\`default_city_id\`);`,
  );
  await db.run(
    sql`ALTER TABLE \`_pages_v_blocks_specialist_directory\` ADD \`default_city_id\` integer REFERENCES cities(id);`,
  );
  await db.run(
    sql`CREATE INDEX \`_pages_v_blocks_specialist_directory_default_city_idx\` ON \`_pages_v_blocks_specialist_directory\` (\`default_city_id\`);`,
  );
  await db.run(
    sql`ALTER TABLE \`reusable_blocks_blocks_specialist_directory\` ADD \`default_city_id\` integer REFERENCES cities(id);`,
  );
  await db.run(
    sql`CREATE INDEX \`reusable_blocks_blocks_specialist_directory_default_city_idx\` ON \`reusable_blocks_blocks_specialist_directory\` (\`default_city_id\`);`,
  );
  await db.run(
    sql`ALTER TABLE \`_reusable_blocks_v_blocks_specialist_directory\` ADD \`default_city_id\` integer REFERENCES cities(id);`,
  );
  await db.run(
    sql`CREATE INDEX \`_reusable_blocks_v_blocks_specialist_directory_default_c_idx\` ON \`_reusable_blocks_v_blocks_specialist_directory\` (\`default_city_id\`);`,
  );
  await db.run(
    sql`ALTER TABLE \`specialists_blocks_specialist_directory\` ADD \`default_city_id\` integer REFERENCES cities(id);`,
  );
  await db.run(
    sql`CREATE INDEX \`specialists_blocks_specialist_directory_default_city_idx\` ON \`specialists_blocks_specialist_directory\` (\`default_city_id\`);`,
  );
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `);
  await db.run(
    sql`INSERT INTO \`__new_pages_blocks_specialist_directory\`("_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "block_name") SELECT "_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "block_name" FROM \`pages_blocks_specialist_directory\`;`,
  );
  ...
  `);
  await db.run(
    sql`INSERT INTO \`__new__pages_v_blocks_specialist_directory\`("_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "_uuid", "block_name") SELECT "_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "_uuid", "block_name" FROM \`_pages_v_blocks_specialist_directory\`;`,
  );
  ...
  `);
  await db.run(
    sql`INSERT INTO \`__new_reusable_blocks_blocks_specialist_directory\`("_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "block_name") SELECT "_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "block_name" FROM \`reusable_blocks_blocks_specialist_directory\`;`,
  );
  ...
  `);
  await db.run(
    sql`INSERT INTO \`__new__reusable_blocks_v_blocks_specialist_directory\`("_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "_uuid", "block_name") SELECT "_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "_uuid", "block_name" FROM \`_reusable_blocks_v_blocks_specialist_directory\`;`,
  );
  ...
  `);
  await db.run(
    sql`INSERT INTO \`__new_specialists_blocks_specialist_directory\`("_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "block_name") SELECT "_order", "_parent_id", "_path", "id", "view", "heading", "description", "only_accepting", "order", "limit", "show_cities", "more_label", "more_href", "empty_text", "visibility_desktop", "visibility_tablet", "visibility_mobile", "block_name" FROM \`specialists_blocks_specialist_directory\`;`,
  );
