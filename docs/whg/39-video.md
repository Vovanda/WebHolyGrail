...
| Обложка набора                              | Карточка набора         |
| Закрыть или открыть все записи набора разом | Карточка набора         |
...
без ключа - набор случайных байт, а исходник после нарезки удаляется. Поэтому
