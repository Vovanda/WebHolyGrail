...
Оригинал удаляется после успешной нарезки, всегда. Смотрят через плейлист, а гигабайтный файл
...
Набор (плейлист) — это **список и ничего больше**: он не меняет доступ входящих роликов. Каскад
