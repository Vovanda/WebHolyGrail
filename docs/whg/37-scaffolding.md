...
3. **rename корня папки** — папка → имя клиента (veo55).
4. **анализ: какие страницы нужны** — Claude (или аналитик) смотрит на бизнес клиента → решает структуру (главная, о нас, услуги, контакты, каталог, форма...).
