...
| Client (фронт)      | Next 15 + React 19 + Tailwind 3.4 + tokens.css                         | 2026-06-19 (этот коммит)      | `sites/veo55/src/client/`                                        | Публичный SSR-фронт; читает CMS через `@veo55/contracts` (R3); токены — единый источник цвета/типографики (R2)                                           |
